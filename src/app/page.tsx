...
export default function Home() {
  ...
  const experiences = [
    {
      ...
      startYear: "2023",
      endYear: "2025",
      description: "Leading development of enterprise applications using Angular, React, and .NET. Architecting scalable solutions for e-commerce and business systems.",
    ...
    },
    {
      ...
      startYear: "2022",
      endYear: "2023",
      description: "Developed collaborative tools and modern web applications. Specialized in creating user-friendly interfaces and robust backend systems.",
    ...
    },
    {
      ...
      startYear: "2020",
      endYear: "2022",
      description: "Created responsive and modern interfaces for various clients. Focused on performance optimization and exceptional user experience.",
    ...
    },
    {
      ...
      startYear: "2018",
      endYear: "2018",
      description: "Graduated with Bachelor's Degree in Computer Science. Presented final thesis project showcasing full-stack development skills and modern web technologies.",
    ...
    },
    {
      ...
      startYear: "2014",
      endYear: "2018",
      description: "Started Computer Science degree at UNIFESO. Built strong foundation in programming, algorithms, data structures, and software engineering principles.",
      techs: ["csharp", "nodejs"]
    }
  ];
  ...
  const generateTimelineItems = () => {
    ...
    for (let i = 0; i < allYears.length; i++) {
      ...
      if (i < allYears.length - 1) {
        ...
        const experiencesInPeriod = visibleExperiences.filter(exp => 
          exp.startYear === nextYear && exp.endYear === year
        );
    ...
    const handleScroll = () => {
      ...
      sections.forEach(sectionId => {
        ...
        if (section) {
          ...
          const centerInSection = viewportCenter >= sectionTop && viewportCenter <= sectionBottom;
          
          if ((visibility > maxVisibility && visibility > 0.3) || centerInSection) {
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        setFormStatus('Thank you for your interest! I will get in touch with you soon.');
        setFormData({
          name: '',
          email: '',
          subject: '',
        ...
        setFormStatus(`Something went wrong. Please try again or contact me directly.`);
      }
    } catch (error) {
  ...
  return (
    <main>
      ...
      <nav className="main-navigation">
        ...
        <div className="nav-right">
          ...
          <a 
            ...
            onClick={(e) => { e.preventDefault(); handleNavigation('experience'); }}
          >
      ...
      <section id="projects" className="projects">
        <div className={`projects-list ${expandedProject !== null ? 'expanded' : ''}`}>
          {projects.map((exp, idx) => (
            <div 
              key={idx} 
              className={`experience-card default ${expandedProject === idx ? 'expanded-card' : ''}`}
              onClick={() => expandedProject === null ? handleProjectExpand(idx) : undefined}
              style={{ cursor: expandedProject === null ? 'pointer' : 'default' }}
            >
              {expandedProject === idx && (
              ...
              <div className="upper">
                ...
                <div className={`experience-description ${expandedProject !== idx ? 'truncated' : ''}`}>
                  {exp.description}
                </div>
              </div>
              <div className="lower">
        ...
        {expandedProject === null && (
          <div className="section-navigation">
            <button className="section-nav-btn" onClick={() => handleNavigation('experience')}>
              <span>Timeline</span>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7 10L12 15L17 10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
      ...
      <section id="experience" className="experience">
        <div className="experience-container">
          ...
          <div className={`timeline-wrapper ${showAllExperiences ? 'expanded' : ''}`}>
            ...
            {timelineItems.map((item) => {
              if (item.type === 'year') {
                ...
                return (
                  <div className={`timeline-item ${item.position}`} key={item.key}>
                    <div className="timeline-card chat-style">
                      <div className="experience-header">
                        <div className="experience-title-text">{exp.title}</div>
                        <div className="experience-company-period">{exp.company} • {exp.period}</div>
                      </div>
            ...
            <div className="experience-expand-container">
              ...
              >
                ...
                <svg 
                  ...
                  viewBox="0 0 24 24" 
                  fill="none" 
                  className={`expand-icon ${showAllExperiences ? 'rotated' : ''}`}
                >
                  <path 
                    d="M7 10L12 15L17 10" 
                    stroke="currentColor" 
          ...
          <div className="section-navigation">
            <button className="section-nav-btn" onClick={() => handleNavigation('contact')}>
              <span>Contact Me</span>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7 10L12 15L17 10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
        ...
        <form onSubmit={handleFormSubmit}>
          ...
          <div className="form-footer">
            <div className="social-networks">
              <a href="https://wa.me/5521976908021" target="_blank" rel="noopener noreferrer" className="social-network">
                <img src="images/icons/whatsapp-icon.svg" alt="WhatsApp" />
              </a>
              <a href="https://www.linkedin.com/in/rafael-oliveiraf/?locale=en_US" target="_blank" rel="noopener noreferrer" className="social-network">
                <img src="images/icons/linkedin-icon.svg" alt="LinkedIn" />
              </a>
              <a href="https://github.com/rafael-faitao" target="_blank" rel="noopener noreferrer" className="social-network">
              ...
              <a href="mailto:rafaeltsd@hotmail.com" target="_blank" rel="noopener noreferrer" className="social-network">
                <img src="images/icons/mail-icon.svg" alt="Email" />
              </a>
            </div>
            <button className="submit-btn" type="submit" disabled={formLoading}>
              {formLoading ? 'Enviando...' : 'Send'} <img src="images/icons/arrow-icon.svg" alt="Arrow" />
            </button>
          </div>
        </form>
        
        <div className="return-to-home">
          <button className="return-btn" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
      ...
      {/* Toast Notification */}
      {formStatus && (
        <div className={`toast ${formStatus.includes('Thank you') ? 'success' : 'error'}`}>
